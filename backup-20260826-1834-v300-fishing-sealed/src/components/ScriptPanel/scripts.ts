...
export const SCRIPTS: ScriptDef[] = [
  ...
  { id: 'AIOCooker', name: 'AIO Cooker', author: 'Dvorak & Kaila', description: 'A basic cooking script to use in Catherby.', categories: ['Skilling'], fileName: 'AIOCooker' },
  ...
  { id: 'CatherbyFishFarm', name: 'Catherby Fish & Cook', author: 'Seatta', description: 'Fishes and cooks fish in Catherby.', categories: ['Skilling'], fileName: 'CatherbyFishFarm' },
  ...
  { id: 'ChickenMunch0r', name: 'ChookMunch0r', author: 'pun@ran@K@whi@rocke@ran@R', description: 'Cooks chicken.', categories: ['Skilling'], fileName: 'ChickenMunch0r' },
