...
const NPC_DROPS: Record<number, number[]> = {
  3: [38],    // Chicken → feathers
  6: [147, 149, 257], // Cow → cowhide, raw beef, bones
  11: [10, 20], // Man → coins, bones
  29: [],    // Rat → nothing
  34: [],    // Spider → nothing
  62: [10, 11, 20], // Goblin → coins, items, bones
  65: [10, 11, 20], // Guard → coins, items, bones
  61: [20, 526], // Giant → bones, big bones
  40: [20],  // Skeleton → bones
  41: [20],  // Zombie → bones
  114: [],   // Imp → nothing (ashes in some versions)
  23: [20],  // Giant Spider → bones
  91: [38],  // Chicken (non-attackable variant) → feathers
  76: [10],  // Barbarian → coins
  93: [],    // Monk → nothing
  139: [],   // Monk of Zamorak → nothing
};
