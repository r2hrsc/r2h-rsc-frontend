...
export interface ScriptDef {
  ...
  hidden?: boolean;    // v335 UI cleanup: unported duplicates of our worked
                       // engines — kept in the catalog, hidden from the list.
                       // Flip to false (or delete the flag) to restore.
}
...
export const SCRIPTS: ScriptDef[] = [
  ...
  { id: 'AIOSmelter', hidden: true, name: 'AIO Smelter', author: 'Dvorak, Searos, Kaila', description: 'Standard Falador/Al-Kharid smelter script.', categories: ['Skilling'], fileName: 'AIOSmelter' },
  { id: 'SmithingVarrock', name: 'Smithing', author: 'Searos & Kaila (R2H port)', description: 'Withdraw bars, smith any item at the nearest anvil (Varrock East / Seers), bank, repeat.', categories: ['Skilling'], fileName: 'SmithingVarrock' },
  { id: 'SmithGearSet', hidden: true, name: 'Smith Gear Sets', author: 'Searos', description: 'Smith entire gear sets.', categories: ['Skilling'], fileName: 'SmithGearSet' },
  { id: 'EssenceMiner', hidden: true, name: 'Essence Miner', author: 'Searos', description: 'Mines and banks rune essence.', categories: ['Skilling'], fileName: 'EssenceMiner' },
  ...
  { id: 'ColeslawGuildFisher', hidden: true, name: 'Guild Fisher', author: 'Searos & Kaila', description: 'Fishes in the fishing guild.', categories: ['Skilling'], fileName: 'ColeslawGuildFisher' },
  { id: 'CatherbyLobs', hidden: true, name: 'Catherby Lobsters', author: 'SaladFork', description: 'Catches lobsters in Catherby.', categories: ['Skilling'], fileName: 'CatherbyLobs' },
  ...
  { id: 'MiningGuild', hidden: true, name: 'Mining Guild', author: 'Seatta', description: 'Mines ores in the Mining Guild.', categories: ['Skilling'], fileName: 'MiningGuild' },
  { id: 'AKMiner', hidden: true, name: 'Al-Kharid Miner', author: 'Dvorak', description: 'A basic mining script with banking for Al-Kharid.', categories: ['Skilling'], fileName: 'AKMiner' },
  { id: 'K_HobsMiner', hidden: true, name: 'Hobgoblin Mine', author: 'Kaila', description: 'Mines Addy/Mith/Coal in Hobgoblin Mine and banks in Edgeville.', categories: ['Skilling'], fileName: 'K_HobsMiner' },
  { id: 'K_EdgeDungeonMine', hidden: true, name: 'Edge Dungeon Mine', author: 'Kaila', description: 'Mines Addy/Mith/Coal in Hobgoblin Mine and banks in Edgeville.', categories: ['Skilling'], fileName: 'K_EdgeDungeonMine' },
  { id: 'K_SkelliCoal', hidden: true, name: 'Skeleton Coal Mine', author: 'Kaila', description: 'Mines coal from the Wilderness skeleton coal mine, banks in edge.', categories: ['Skilling'], fileName: 'K_SkelliCoal' },
  { id: 'CraftingGuildMining', hidden: true, name: 'Crafting Guild Mine', author: 'Searos & Kaila', description: 'Mines gold, silver, and clay in the crafting guild.', categories: ['Skilling'], fileName: 'CraftingGuildMining' },
  { id: 'CeikPlates', hidden: true, name: 'Steel Platebody Smither', author: 'Ceikry', description: 'Steel Platebody Smither by Ceikry.', categories: ['Skilling'], fileName: 'CeikPlates' },
  ...
  { id: 'K_ArdyYewTree', hidden: true, name: 'Ardougne Yews', author: 'Kaila', description: 'Cuts yew trees north east of Ardougne. Requires 53+ Combat to avoid aggressive bears!', categories: ['Skilling'], fileName: 'K_ArdyYewTree' },
  { id: 'K_GnomeMagicTree', hidden: true, name: 'Gnome Magic Trees', author: 'Kaila', description: 'Cuts Magic trees in the Tree Gnome Stronghold.', categories: ['Skilling'], fileName: 'K_GnomeMagicTree' },
  { id: 'K_SeersMagicTree', hidden: true, name: "Seers' Magic Trees", author: 'Kaila', description: "Cuts Magic logs in Seers' Village.", categories: ['Skilling'], fileName: 'K_SeersMagicTree' },
  { id: 'ChickenMunch0r', hidden: true, name: 'ChookMunch0r', author: 'pun@ran@K@whi@rocke@ran@R', description: 'Catherby — withdraws raw food, cooks, banks.', categories: ['Skilling'], fileName: 'ChickenMunch0r' },
  ...
  { id: 'PowercraftTalisman', hidden: true, name: 'Powercraft Talisman', author: 'Searos', description: 'Trains mining and crafting at the essence rocks.', categories: ['Skilling'], fileName: 'PowercraftTalisman' },
  ...
  { id: 'K_FastChainLinks', hidden: true, name: 'Chain Link Maker', author: 'Kaila', description: 'Makes Chain Links from dragon longs for Dragon Scale Mail armor.', categories: ['Skilling'], fileName: 'K_FastChainLinks' },
  { id: 'K_NoBank_Superheat', hidden: true, name: 'Superheat Smith', author: 'Kaila', description: 'Mines, superheats, and smiths iron into plate bodies.', categories: ['Magic', 'Skilling'], fileName: 'K_NoBank_Superheat' },
